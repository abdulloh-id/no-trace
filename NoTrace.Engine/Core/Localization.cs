...
public static class LocaleManager
{
    ...
    private static void InitializeEnglishProfile()
    {
        Translations[Language.EN] = new Dictionary<TextKey, string>
        {
            ...
            [TextKey.Level4Desc] = "4. [NoTrace]     - Wipe history, BLOCK, and REMOVE (Zero metadata)",
            ...
            [TextKey.GuiLevel4Name] = "Level 4: Forensic (Block, zero metadata & delete contact)",
    ...
    private static void InitializeUzbekProfile()
    {
        Translations[Language.UZ] = new Dictionary<TextKey, string>
        {
            ...
            [TextKey.Level4Desc] = "4. [Izsiz]          - Tarixni o‘chirish, BLOKLASH va aloqani mutloq uzish (Metasiz)",
            ...
            [TextKey.GuiLevel4Name] = "4-daraja: Izsiz (Bloklash, aloqani mutloq uzish va ghost kontaktni o‘chirish)",
    ...
    private static void InitializeRussianProfile()
    {
        Translations[Language.RU] = new Dictionary<TextKey, string>
        {
            ...
            [TextKey.Level4Desc] = "4. [Без Следа]      - Стереть историю, ЗАБЛОКИРОВАТЬ и УДАЛИТЬ связь (Без метаданных)",
            ...
            [TextKey.GuiLevel4Name] = "Уровень 4: Без Следа (Блокировка, удаление всех метаданных и контакта)",
